...
/**
 * Strings for component 'tiny_html_components', language 'en'.
 *
...
$string['custom_components_delete_confirm'] = 'Do you really want to permanently delete this component?';
...
$string['html_components:desc'] = 'Insert HTML components';
...
$string['pluginname'] = 'Insert HTML components';
...
$string['privacy:metadata:tiny_html_components_custom'] = 'A table storing custom components usable in the TinyMCE editor';
$string['privacy:metadata:tiny_html_components_custom:content'] = 'The HTML code representing the component';
$string['privacy:metadata:tiny_html_components_custom:name'] = 'The custom component\'s name';
$string['privacy:metadata:tiny_html_components_custom:userid'] = 'The user ID of the user who created the custom component';
$string['suggestion'] = '';
