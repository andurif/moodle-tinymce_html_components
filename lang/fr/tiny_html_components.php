...
/**
 * Strings for component 'tiny_html_components', language 'fr'.
 *
...
$string['custom_components_delete_confirm'] = 'Voulez-vous vraiment supprimer définitivement ce composant ?';
...
$string['pluginname'] = 'Insertion de composants HTML';
...
$string['privacy:metadata:tiny_html_components_custom'] = 'Une table stockant des composants personnalisés utilisables dans l\'éditeur TinyMCE';
$string['privacy:metadata:tiny_html_components_custom:content'] = 'Le code HTML représentant le composant';
$string['privacy:metadata:tiny_html_components_custom:name'] = 'Le nom du composant personnalisé';
$string['privacy:metadata:tiny_html_components_custom:userid'] = 'L\'identifiant de l\'utilisateur qui a créé le composant personnalisé';
$string['suggestion'] = '';
