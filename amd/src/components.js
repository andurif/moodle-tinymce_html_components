...
const components = [
    {
        ...
        code: function () {
            ...
            for (var i = 1; i <= nb_collapse; i++){
                txt += "<div class='card'>" +
                    "    <div class='card-header' id='heading" + uniq + "_" + i + "'>" +
                    "      <h3 class='mb-0'>" +
                    "        <button class='btn btn-link btn-block"+
                    " text-left collapsed' type='button' data-toggle='collapse' data-target='#collapse"+
                                uniq + "_" + i + "' aria-expanded='false' aria-controls='collapse" + uniq + "_" + i + "'>" +
                    "          Collapsible Group Item #" + i + "" +
                    "        </button>" +
                    "      </h3>" +
                    "    </div>" +
                    "    <div id='collapse" + uniq + "_" + i + "' class='" + collapse_class + "' aria-labelledby='heading" +
                                uniq + "_" + i + "' data-parent='#accordion" + uniq + "'>" +
                    "      <div class='card-body'>" +
    ...
    },
    {
        ...
        code: function() {
            ...
            return "<div class='alert alert-" + document.getElementById('alert_type').value +
             "'>" + close + "Contenu de votre alerte !</div>";
       },
    },
    {
        id: 2,
    ...
    },
    {
        ...
        code: function () {
            ...
            ? "primary" : "light";
            var background = (card_background == "image") ? "<img src='https://cdn.html.fr/images/ent/background_ent_2.jpg'"+
